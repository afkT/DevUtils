...
import afkt.project.databinding.FragmentUiEffectQrcodeScanBinding
 ...
 * @author Ttt
 */
class QRCodeScanFragment : AppFragment<FragmentUiEffectQrcodeScanBinding, QRCodeScanViewModel>(
    R.layout.fragment_ui_effect_qrcode_scan, BR.viewModel, simple_Agile = { frg ->
...
class QRCodeScanViewModel : AppViewModel() {
