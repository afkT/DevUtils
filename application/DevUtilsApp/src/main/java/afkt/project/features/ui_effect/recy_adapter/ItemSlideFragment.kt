 ...
 */
class ItemSlideFragment : AppFragment<BaseViewRecyclerviewBinding, AppViewModel>(
    R.layout.base_view_recyclerview, BR.viewModel, simple_Agile = {
        if (it is ItemSlideFragment) {
            it.apply {
