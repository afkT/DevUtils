...
public final class SnackbarUse {
    ...
    public void snackbarUse() {
        ...
        boolean autoCalc = SnackbarUtils.with(view).isAutoCalc(); // 只有调用 above / below 该属性才有意义
        ...
        SnackbarUtils.with(view).setAutoCalc(true); // 只有调用 above / below 该属性才有意义
