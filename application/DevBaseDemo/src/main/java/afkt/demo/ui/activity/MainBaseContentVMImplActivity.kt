 ...
 * @author Ttt
 */
class MainBaseContentVMImplActivity : DevBaseContentMVVMActivity<ActivityMainContentVmImplBinding, MVVM.VMImpl>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        contentAssist.addTitleView(
            QuickHelper.get(TextView(this))
                ...
                .setBackgroundColor(ResourceUtils.getColor(R.color.pink)).setWidthHeight(
                    ViewUtils.MATCH_PARENT, ResourceUtils.getDimensionInt(R.dimen.dp_50)
                ).setGravity(Gravity.CENTER).setBold().setOnClick { view ->
        ...
        contentAssist.addFloatView(
            QuickHelper.get(ImageView(this)).setWidthHeight(
                ResourceUtils.getDimensionInt(R.dimen.dp_50),
                ResourceUtils.getDimensionInt(R.dimen.dp_50)
            ).setImageResource(R.mipmap.icon_launcher_round).getView()
        )
        ...
        contentAssist.floatFrame?.let {
            QuickHelper.get(ViewUtils.getChildAtLast<ImageView>(it))
                ...
                .setLayoutGravity(Gravity.END or Gravity.BOTTOM).setOnClick {
