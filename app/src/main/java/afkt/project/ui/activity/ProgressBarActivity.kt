...
//        // 内外圆环 + 数字 + 无扇形
//        binding.vidBar1.setProgressStyle(LoadProgressBar.ProgressStyle.RINGS)
...
//
//        // 扇形 + 数字 + 无内外圆环
//        binding.vidBar2.setProgressStyle(LoadProgressBar.ProgressStyle.FAN_SHAPED)
//            .setProgressColor(ResourceUtils.getColor(R.color.sky_blue)).isCanvasNumber =
//            true // 是否绘制数字
//
//        // 扇形 + 数字 + 外圆环
//        binding.vidBar3.setProgressStyle(LoadProgressBar.ProgressStyle.ARC_FAN_SHAPED)
...
//
//        // 单独字体
//        binding.vidBar4.setProgressStyle(LoadProgressBar.ProgressStyle.NUMBER)
...
//            ResourceUtils.getColor(R.color.deeppink) // 字体颜色
    ...
    private val handler: Handler = object : Handler() {
        override fun handleMessage(msg: Message) {
            ...
            try {
                val progress = binding.vidBar1.progress + 1
                // 每次进行累加
                binding.vidBar1.progress = progress
                binding.vidBar2.progress = progress
                binding.vidBar3.progress = progress
                binding.vidBar4.progress = progress
                // 判断是否符合条件
                if (binding.vidBar1.progress < binding.vidBar1.max) {
                    // 延迟发送通知
