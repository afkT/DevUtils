...
object ButtonList {
    ...
    val moduleFrameworkButtonValues: List<ButtonValue>
        get() {
            val lists: MutableList<ButtonValue> = ArrayList()
            lists.add(ButtonValue(ButtonValue.BTN_MVP, "MVP"))
            lists.add(ButtonValue(ButtonValue.BTN_MVVM, "MVVM"))
            return lists
        }
    ...
    val moduleLibButtonValues: List<ButtonValue>
        get() {
            val lists: MutableList<ButtonValue> = ArrayList()
            lists.add(ButtonValue(ButtonValue.BTN_EVENT_BUS, "EventBusUtils"))
            ...
            lists.add(ButtonValue(ButtonValue.BTN_GREEN_DAO, "GreenDAO"))
            lists.add(ButtonValue(ButtonValue.BTN_ROOM, "Room"))
    ...
    val moduleUIButtonValues: List<ButtonValue>
        get() {
            val lists: MutableList<ButtonValue> = ArrayList()
            lists.add(ButtonValue(ButtonValue.BTN_TOAST_TINT, "ToastTint ( 着色美化 Toast )"))
            lists.add(ButtonValue(ButtonValue.BTN_UI_EFFECT, "常见 UI、GradientDrawable 效果等"))
            lists.add(ButtonValue(ButtonValue.BTN_STATUS_BAR, "点击 显示/隐藏 ( 状态栏 )"))
            lists.add(ButtonValue(ButtonValue.BTN_TEXT_CALC, "计算字体宽度、高度"))
            lists.add(ButtonValue(ButtonValue.BTN_ADAPTER_EDITS, "Adapter Item EditText 输入监听"))
            lists.add(ButtonValue(ButtonValue.BTN_MULTI_SELECT, "多选辅助类 MultiSelectAssist"))
            lists.add(ButtonValue(ButtonValue.BTN_GPU_ACV, "GPU ACV 文件滤镜效果"))
            lists.add(ButtonValue(ButtonValue.BTN_GPU_FILTER, "GPU 滤镜效果"))
            lists.add(ButtonValue(ButtonValue.BTN_QRCODE_CREATE, "创建二维码"))
            lists.add(ButtonValue(ButtonValue.BTN_QRCODE_IMAGE, "二维码图片解析"))
            lists.add(ButtonValue(ButtonValue.BTN_QRCODE_SCAN, "二维码扫描解析"))
            lists.add(ButtonValue(ButtonValue.BTN_CAPTURE_PICTURE, "CapturePictureUtils 截图工具类"))
            lists.add(ButtonValue(ButtonValue.BTN_TEXTVIEW, "两个 TextView 显示效果"))
            lists.add(ButtonValue(ButtonValue.BTN_ITEM_STICKY, "RecyclerView 吸附效果"))
            lists.add(ButtonValue(ButtonValue.BTN_RECY_ITEM_SLIDE, "RecyclerView 滑动删除、上下滑动"))
            lists.add(
                ButtonValue(
            ...
            lists.add(ButtonValue(ButtonValue.BTN_RECY_LINEAR_SNAP_MAX, "LinearSnapHelper - 无限滑动"))
            lists.add(
                ButtonValue(
            ...
            lists.add(ButtonValue(ButtonValue.BTN_PALETTE, "Palette 调色板"))
            lists.add(ButtonValue(ButtonValue.BTN_FLEXBOX_LAYOUTMANAGER, "Flexbox LayoutManager"))
            lists.add(ButtonValue(ButtonValue.BTN_CHIP, "Material Chip、ChipGroups、ChipDrawable"))
            lists.add(ButtonValue(ButtonValue.BTN_VIEWPAGER2, "ViewPager2"))
            return lists
        }
    ...
    val toastButtonValues: List<ButtonValue>
        get() {
            ...
            lists.add(ButtonValue(ButtonValue.BTN_TOAST_TINT_CUSTOM_STYLE, "Toast Custom Style"))
            return lists
        }
    ...
    val moduleOtherButtonValues: List<ButtonValue>
        get() {
            val lists: MutableList<ButtonValue> = ArrayList()
            lists.add(ButtonValue(ButtonValue.BTN_LISTENER, "事件 / 广播监听 ( 网络状态、屏幕旋转等 )"))
            lists.add(
                ButtonValue(
            ...
            lists.add(ButtonValue(ButtonValue.BTN_WIFI, "Wifi 相关 ( 热点 )"))
            lists.add(ButtonValue(ButtonValue.BTN_FUNCTION, "铃声、震动、通知栏等功能"))
            lists.add(ButtonValue(ButtonValue.BTN_TIMER, "TimerManager 定时器工具类"))
            lists.add(ButtonValue(ButtonValue.BTN_CACHE, "DevCache 缓存工具类"))
            lists.add(ButtonValue(ButtonValue.BTN_LOGGER, "DevLogger 日志工具类"))
            lists.add(ButtonValue(ButtonValue.BTN_FILE_RECORD, "日志、异常文件记录保存"))
            lists.add(ButtonValue(ButtonValue.BTN_CRASH, "奔溃日志捕获"))
            lists.add(ButtonValue(ButtonValue.BTN_PATH, "路径信息"))
            lists.add(ButtonValue(ButtonValue.BTN_WEBVIEW, "WebView 辅助类"))
            lists.add(
                ButtonValue(
            ...
            lists.add(ButtonValue(ButtonValue.BTN_ADD_CONTACT, "添加联系人"))
            lists.add(ButtonValue(ButtonValue.BTN_WALLPAPER, "手机壁纸"))
            return lists
        }
    ...
    val functionButtonValues: List<ButtonValue>
        get() {
            ...
            lists.add(ButtonValue(ButtonValue.BTN_FUNCTION_APP_DETAILS_SETTINGS, "跳转到 APP 设置详情页面"))
    ...
    val fileRecordButtonValues: List<ButtonValue>
        get() {
            val lists: MutableList<ButtonValue> = ArrayList()
            lists.add(ButtonValue(ButtonValue.BTN_FILE_RECORD_ANALYSIS, "AnalysisRecordUtils 工具类"))
            lists.add(ButtonValue(ButtonValue.BTN_FILE_RECORD_UTILS, "FileRecordUtils 工具类"))
            return lists
        }
    ...
    val moduleDevWidgetButtonValues: List<ButtonValue>
        get() {
            val lists: MutableList<ButtonValue> = ArrayList()
            lists.add(ButtonValue(ButtonValue.BTN_VIEW_PAGER, "ViewPager 滑动监听、控制滑动"))
            lists.add(ButtonValue(ButtonValue.BTN_CUSTOM_PROGRESS_BAR, "自定义 ProgressBar 样式 View"))
            lists.add(ButtonValue(ButtonValue.BTN_SCAN_VIEW, "自定义扫描 View ( QRCode、AR )"))
            lists.add(ButtonValue(ButtonValue.BTN_WRAP_VIEW, "自动换行 View"))
            lists.add(ButtonValue(ButtonValue.BTN_SIGN_VIEW, "签名 View"))
            lists.add(ButtonValue(ButtonValue.BTN_LINE_VIEW, "换行监听 View"))
            lists.add(ButtonValue(ButtonValue.BTN_LIKE_VIEW, "自定义点赞效果 View"))
            lists.add(ButtonValue(ButtonValue.BTN_CORNER_LABEL_VIEW, "自定义角标 View"))
            lists.add(ButtonValue(ButtonValue.BTN_VIEW_ASSIST, "View 填充辅助类"))
            return lists
        }
    ...
    val viewAssistButtonValues: List<ButtonValue>
        get() {
            val lists: MutableList<ButtonValue> = ArrayList()
            lists.add(ButtonValue(ButtonValue.BTN_VIEW_ASSIST_RECYCLER, "RecyclerView ( loading )"))
            lists.add(ButtonValue(ButtonValue.BTN_VIEW_ASSIST_ERROR, "Error ( failed )"))
            lists.add(ButtonValue(ButtonValue.BTN_VIEW_ASSIST_EMPTY, "Empty ( data )"))
            lists.add(ButtonValue(ButtonValue.BTN_VIEW_ASSIST_CUSTOM, "Custom Type"))
            return lists
        }
