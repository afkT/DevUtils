...
[![Cocoapods](https://img.shields.io/badge/DevUtils-1.6.6-brightgreen.svg)](https://github.com/afkT/DevUtils)
...
dependencies {
	...
	implementation 'com.github.afkT:DevUtils:1.6.6@aar'
}
```
...
- [JavaDoc - API](https://javadoc.jitpack.io/com/github/afkT/DevUtils/1.6.6/javadoc/)
