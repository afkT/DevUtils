...
[![Bintray](https://img.shields.io/badge/DevUtils-2.1.4-brightgreen.svg)](https://bintray.com/afkt/maven/DevAppX)
...
// DevJava Java 工具类库 ( 不依赖 android api )
implementation 'com.afkt:DevJava:1.2.5' // 用于纯 Java 开发，如果依赖了 DevApp 则不需要依赖 DevJava
