...
[![Cocoapods](https://img.shields.io/badge/DevUtils-1.6.4-brightgreen.svg)](https://github.com/afkT/DevUtils)
...
> <p>该项目尽可能的便于开发人员，快捷、快速开发安全可靠的项目，以及内置部分常用的资源文件，如 color.xml、toast_layout.xml 等
...
dependencies {
	...
	implementation 'com.github.afkT:DevUtils:1.6.4@aar'
}
```
