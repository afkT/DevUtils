...
final class Config {
    ...
    static {
        ...
        sDevUtilsCatelogMap.put(".Widget", "部分自定义 View 功能、效果");
        sDevUtilsCatelogMap.put(".Widget.DevWidget", "自定义 View UI 库");
        sDevUtilsCatelogMap.put(".Widget.TempWidget", "临时自定义 View 编写");
