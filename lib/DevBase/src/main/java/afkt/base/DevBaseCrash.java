...
/**
 * detail: UncaughtException 处理类
 * @author Ttt
 * <pre>
 *     当程序发生 Uncaught 异常的时候, 由该类来接管程序, 并记录发送错误报告
 * </pre>
 */
public final class DevBaseCrash implements UncaughtExceptionHandler {

    // DevBaseCrash 实例
    private static DevBaseCrash INSTANCE = new DevBaseCrash();
    // Context
    ...
    private DevBaseCrash() {
    }

    /**
     * 获取 DevBaseCrash 实例
     * @return {@link DevBaseCrash}
     */
    public static DevBaseCrash getInstance() {
        return INSTANCE;
    }
