 ...
 * @author Ttt
 */
public abstract class DevBaseContentMVPViewBindingActivity<P extends MVP.Presenter, VB extends ViewBinding>
        extends DevBaseContentViewBindingActivity<VB> implements MVP.IView {
