...
public class RadiusTextView
     ...
     */
    @Override
    public RadiusTextView setClearRadius(final boolean clear) {
     ...
     */
    @Override
    public RadiusTextView clearRadius() {
     ...
     */
    @Override
    public RadiusTextView setRadius(final float radius) {
     ...
     */
    @Override
    public RadiusTextView setRadiusLeftTop(final float radiusLeftTop) {
     ...
     */
    @Override
    public RadiusTextView setRadiusLeftBottom(final float radiusLeftBottom) {
     ...
     */
    @Override
    public RadiusTextView setRadiusRightTop(final float radiusRightTop) {
     ...
     */
    @Override
    public RadiusTextView setRadiusRightBottom(final float radiusRightBottom) {
     ...
     */
    @Override
    public RadiusTextView setRadiusLeft(final float radiusLeft) {
     ...
     */
    @Override
    public RadiusTextView setRadiusRight(final float radiusRight) {
     ...
     */
    @Override
    public RadiusTextView setRadiusTop(final float radiusTop) {
     ...
     */
    @Override
    public RadiusTextView setRadiusBottom(final float radiusBottom) {
