...
public class RadiusLinearLayout
     ...
     * @return {@link RadiusLinearLayout}
     */
    @Override
    public RadiusLinearLayout setClearRadius(final boolean clear) {
     ...
     */
    @Override
    public RadiusLinearLayout clearRadius() {
     ...
     */
    @Override
    public RadiusLinearLayout clearRadius(final boolean invalidate) {
     ...
     */
    @Override
    public RadiusLinearLayout setRadius(final float radius) {
     ...
     */
    @Override
    public RadiusLinearLayout setRadiusLeftTop(final float radiusLeftTop) {
     ...
     */
    @Override
    public RadiusLinearLayout setRadiusLeftBottom(final float radiusLeftBottom) {
     ...
     */
    @Override
    public RadiusLinearLayout setRadiusRightTop(final float radiusRightTop) {
     ...
     */
    @Override
    public RadiusLinearLayout setRadiusRightBottom(final float radiusRightBottom) {
     ...
     */
    @Override
    public RadiusLinearLayout setRadiusLeft(final float radiusLeft) {
     ...
     */
    @Override
    public RadiusLinearLayout setRadiusRight(final float radiusRight) {
     ...
     */
    @Override
    public RadiusLinearLayout setRadiusTop(final float radiusTop) {
     ...
     */
    @Override
    public RadiusLinearLayout setRadiusBottom(final float radiusBottom) {
