 ...
 * @return PopTip 对象
 */
fun poptip_showSingle(
    engine: String? = null,
    text: CharSequence?
): Any? {
    return engine.getPopTipEngine()?.showSingle(text)
}
 ...
 * @return PopTip 对象
 */
fun <Item : IPopTipEngine.EngineItem> Item?.poptip_showSingle(
    engine: String? = null
): Any? {
    return engine.getPopTipEngine()?.showSingle(this)
}
...
fun <Item : IPopTipEngine.EngineItem> Item?.poptip_showSingle(
    ...
    return engine.getPopTipEngine()?.showSingle(activity, this)
}
 ...
 */
fun poptip_isShow(engine: String? = null): Boolean {
    return engine.getPopTipEngine()?.isShow ?: false
}
 ...
 * @param engine String?
 */
fun poptip_dismiss(engine: String? = null) {
    engine.getPopTipEngine()?.dismiss()
}
...
fun poptip_dismiss(
    ...
    engine.getPopTipEngine()?.dismiss(popTip)
}
 ...
 * @param engine String?
 */
fun poptip_hide(engine: String? = null) {
    engine.getPopTipEngine()?.hide()
}