...
* **ValueMutableLiveData.smartUpdateValue**：主线程 `updateValue` / 后台 `postUpdateValue` 智能选择；**AdapterModel** 列表模型与空态 `existData`
...
* **ValueMutableLiveData ->** [ValueMutableLiveData.kt](https://github.com/afkT/DevUtils/blob/master/lib/DevSimple/src/main/java/dev/simple/core/livedata/ValueMutableLiveData.kt)
