package dev.simple.features.web
...
open class WebViewAssist @JvmOverloads constructor(listener: Boolean = true) {
    ...
    /**
     * 设置处理各种通知和请求事件对象
     * @param client [android.webkit.WebViewClient]
     * @return [WebViewAssist]
     * 常用方法
     ...
     * @param client [android.webkit.WebChromeClient]
     * @return [WebViewAssist]
     * 常用方法
    ...
    open class Builder @JvmOverloads constructor(listener: OnApplyListener? = null) {
        ...
        open fun reset(): Builder {
            ...
            this.mCacheMode = WebSettings.LOAD_DEFAULT
