...
public final class ListViewUtils {
     ...
     */
    public static <T extends View> boolean smoothScrollToPosition(
            final T view,
            final int position
    ) {
        if (view != null && position >= 0) {
            try {
                ...
                LogPrintUtils.eTag(TAG, e, "smoothScrollToPosition: %s", position);
            }
        }
        return false;
    }
     ...
     * @return {@code true} success, {@code false} fail
     */
    public static <T extends View> boolean scrollToPosition(
            final T view,
            final int position
    ) {
        if (view != null && position >= 0) {
            try {
                ...
                LogPrintUtils.eTag(TAG, e, "scrollToPosition: %s", position);
            }
        }
        return false;
    }
     ...
     * @return {@code true} success, {@code false} fail
     */
    public static <T extends View> boolean smoothScrollToTop(final T view) {
        if (view != null) {
            if (view instanceof RecyclerView || view instanceof ListView || view instanceof GridView) {
                return smoothScrollToPosition(view, 0);
            } else { // 其他 View
                return smoothScrollTo(view, 0, 0);
            }
        }
        return false;
    }
     ...
     * @return {@code true} success, {@code false} fail
     */
    public static <T extends View> boolean scrollToTop(final T view) {
        if (view != null) {
            if (view instanceof RecyclerView || view instanceof ListView || view instanceof GridView) {
                return scrollToPosition(view, 0);
            } else { // 其他 View
                return scrollTo(view, 0, 0);
            }
        }
        return false;
    }
     ...
     * @return {@code true} success, {@code false} fail
     */
    public static <T extends View> boolean smoothScrollToBottom(final T view) {
        if (view != null) {
            try {
                if (view instanceof RecyclerView) {
                    RecyclerView            recyclerView = (RecyclerView) view;
                    ...
                    return fullScroll(view, View.FOCUS_DOWN);
                }
            } catch (Exception e) {
                LogPrintUtils.eTag(TAG, e, "smoothScrollToBottom");
            }
        }
        return false;
    }
     ...
     * @return {@code true} success, {@code false} fail
     */
    public static <T extends View> boolean scrollToBottom(final T view) {
        if (view != null) {
            try {
                if (view instanceof RecyclerView) {
                    RecyclerView            recyclerView = (RecyclerView) view;
                ...
                LogPrintUtils.eTag(TAG, e, "scrollToBottom");
            }
        }
        return false;
    }
     ...
     * @return {@code true} success, {@code false} fail
     */
    public static <T extends View> boolean smoothScrollTo(
            final T view,
            final int x,
            final int y
    ) {
        if (view != null) {
            try {
                ...
                LogPrintUtils.eTag(TAG, e, "smoothScrollTo x: %s, y: %s", x, y);
            }
        }
        return false;
    }
     ...
     * @return {@code true} success, {@code false} fail
     */
    public static <T extends View> boolean smoothScrollBy(
            final T view,
            final int x,
            final int y
    ) {
        try {
            ...
            LogPrintUtils.eTag(TAG, e, "smoothScrollBy x: %s, y: %s", x, y);
        }
        return false;
    }
     ...
     * @return {@code true} success, {@code false} fail
     */
    public static <T extends View> boolean fullScroll(
            final T view,
            final int direction
    ) {
        if (view != null) {
            try {
                ...
                LogPrintUtils.eTag(TAG, e, "fullScroll direction: %s", direction);
            }
        }
        return false;
    }
     ...
     * @return {@code true} success, {@code false} fail
     */
    public static boolean scrollTo(
            final View view,
            final int x,
            final int y
    ) {
        try {
            ...
            LogPrintUtils.eTag(TAG, e, "scrollTo x: %s, y: %s", x, y);
        }
        return false;
    }
     ...
     * @return {@code true} success, {@code false} fail
     */
    public static boolean scrollBy(
            final View view,
            final int x,
            final int y
    ) {
        try {
            ...
            LogPrintUtils.eTag(TAG, e, "scrollBy x: %s, y: %s", x, y);
        }
        return false;
    }
     ...
     * @return {@code true} success, {@code false} fail
     */
    public static boolean setScrollX(
            final View view,
            final int value
    ) {
        try {
            ViewUtils.setScrollX(view, value);
            return true;
        } catch (Exception e) {
            LogPrintUtils.eTag(TAG, e, "setScrollX x: %s", value);
        }
        return false;
    }
     ...
     * @return {@code true} success, {@code false} fail
     */
    public static boolean setScrollY(
            final View view,
            final int value
    ) {
        try {
            ViewUtils.setScrollY(view, value);
            return true;
        } catch (Exception e) {
            LogPrintUtils.eTag(TAG, e, "setScrollY y: %s", value);
        }
        return false;
    }
