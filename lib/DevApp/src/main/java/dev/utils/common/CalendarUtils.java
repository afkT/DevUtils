...
public final class CalendarUtils {
    ...
    private static final String[]       TIAN_GAN            = {"甲", "乙", "丙", "丁", "戊", "己", "庚",
            "辛", "壬", "癸"};
    // 地支
    private static final String[]       DI_ZHI              = {"子", "丑", "寅", "卯", "辰", "巳", "午",
            "未", "申", "酉", "戌", "亥"};
    // 中文年份
    private static final String[]       CHINESE_NUMBER      = {"正", "二", "三", "四", "五",
            "六", "七", "八", "九", "十", "冬", "腊"};
    // 中文十位数
    private static final String[]       CHINESE_TEN         = {"初", "十", "廿", "三"}; // 卅
    // 中文一到十
    private static final String[]       CHINESE_DAY         = {"一", "二", "三", "四", "五", "六", "七",
            "八", "九", "十"};
    // 二十四节气 ( 公历 )
