 ...
 * @author Ttt
 * <pre>
 *     适用于不方便继承 {@link DevDataAdapter} 类, 但提供相同功能 DataManager
 * </pre>
 */
public abstract class DevDataList<T, VH extends RecyclerView.ViewHolder>
     ...
     */
    public DevDataList<T, VH> setContext(final Context context) {
        this.mContext = context;
        return this;
    }
     ...
     * @return {@link DevDataList}
     */
    public DevDataList<T, VH> setActivity(Activity activity) {
        this.mActivity = activity;
        return this;
    }
     ...
     * @return {@link DevDataList}
     */
    public DevDataList<T, VH> parentContext(ViewGroup parent) {
