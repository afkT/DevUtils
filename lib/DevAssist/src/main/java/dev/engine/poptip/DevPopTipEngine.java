...
/**
 * detail: PopTip Engine
 * @author Ttt
 */
public final class DevPopTipEngine {

    private DevPopTipEngine() {
    }

    private static final DevEngineAssist<IPopTipEngine> sAssist = new DevEngineAssist<>();

    /**
     * 获取 Engine
     * @return {@link IPopTipEngine}
     */
    public static IPopTipEngine getEngine() {
     ...
     * @return {@link IPopTipEngine}
     */
    public static IPopTipEngine getEngine(final String key) {
     ...
     * @return {@link IPopTipEngine}
     */
    public static IPopTipEngine setEngine(final IPopTipEngine engine) {
     ...
     * @return {@link IPopTipEngine}
     */
    public static IPopTipEngine setEngine(
            final String key,
            final IPopTipEngine engine
    ) {
     ...
     */
    public static DevEngineAssist<IPopTipEngine> getAssist() {
        return sAssist;
    }
     ...
     * @return Engine Map
     */
    public static Map<String, IPopTipEngine> getEngineMaps() {
