...
/**
 * detail: Refresh View Engine
 * @author Ttt
 */
public final class DevRefreshEngine {

    private DevRefreshEngine() {
    }

    private static final DevEngineAssist<IRefreshEngine> sAssist = new DevEngineAssist<>();

    /**
     * 获取 Engine
     * @return {@link IRefreshEngine}
     */
    public static IRefreshEngine getEngine() {
     ...
     * @return {@link IRefreshEngine}
     */
    public static IRefreshEngine getEngine(final String key) {
     ...
     * @return {@link IRefreshEngine}
     */
    public static IRefreshEngine setEngine(final IRefreshEngine engine) {
     ...
     * @return {@link IRefreshEngine}
     */
    public static IRefreshEngine setEngine(
            final String key,
            final IRefreshEngine engine
    ) {
     ...
     */
    public static DevEngineAssist<IRefreshEngine> getAssist() {
        return sAssist;
    }
     ...
     * @return Engine Map
     */
    public static Map<String, IRefreshEngine> getEngineMaps() {
