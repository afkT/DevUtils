...
/**
 * detail: Router Engine
 * @author Ttt
 */
public final class DevRouterEngine {

    private DevRouterEngine() {
    }

    private static final DevEngineAssist<IRouterEngine> sAssist = new DevEngineAssist<>();

    /**
     * 获取 Engine
     * @return {@link IRouterEngine}
     */
    public static IRouterEngine getEngine() {
     ...
     * @return {@link IRouterEngine}
     */
    public static IRouterEngine getEngine(final String key) {
     ...
     * @return {@link IRouterEngine}
     */
    public static IRouterEngine setEngine(final IRouterEngine engine) {
     ...
     * @return {@link IRouterEngine}
     */
    public static IRouterEngine setEngine(
            final String key,
            final IRouterEngine engine
    ) {
     ...
     */
    public static DevEngineAssist<IRouterEngine> getAssist() {
        return sAssist;
    }
     ...
     * @return Engine Map
     */
    public static Map<String, IRouterEngine> getEngineMaps() {
