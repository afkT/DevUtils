...
public final class EncryptUtils {
     ...
     * @param data 待加密数据
     * @param key  密钥
     * @return HmacSHA224 加密后的数据转 十六进制
     */
     ...
     * @param data 待加密数据
     * @param key  密钥
     * @return HmacSHA256 加密后的数据转 十六进制
     */
     ...
     * @param data 待加密数据
     * @param key  密钥
     * @return HmacSHA384 加密后的数据转 十六进制
     */
     ...
     * @param data 待加密数据
     * @param key  密钥
     * @return HmacSHA512 加密后的数据转 十六进制
     */
