...
public final class AppInfoItem {
    ...
    private AppInfoItem(PackageInfo pInfo){
        ...
        // 证书有效期
        listKeyValues.add(KeyValueBean.get(R.string.dev_str_effective, effective));
        // 判断是否过期
        listKeyValues.add(KeyValueBean.get(R.string.dev_str_iseffective, isEffective ? context.getString(R.string.dev_str_overdue) : context.getString(R.string.dev_str_notoverdue)));
        // 证书发布方
